...
# date = "2020-01-04"
date = "now"
# Максимальное количество результатов, которое может быть загружено для 1 запроса
# Больше 50 скорее всего не имеет смысла, т.к. в хвосте будут менее релевантные результаты
# Нормальное значение 20-30
max_results = 30
